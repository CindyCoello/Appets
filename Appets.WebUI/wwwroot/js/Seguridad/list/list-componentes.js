appConfig.Componentes = (function () {
    var obj = {};
                ...
                columnDefs: [
                    ...
                    },
                    {
                        ...
                        render: function (data, type, row) {
                            botones = "";
                            if (type == "display") {
                                botones += '<button class="btn btn-secondary btn-sm edit-btn ladda-button" data-style="zoom-in" data-id="' + row.comp_Id + '"><span class"ladda-label"><i class="mdi mdi-square-edit-outline"></i></span></button> | ';
                                //botones += '<button class="btn btn-danger btn-sm" onclick="EliminarRole(' + row.comp_Id + ')"><i class="mdi mdi-delete-empty"></i></button>';
                                
                                botones += '<a class="btn btn-danger btn-sm" href="/Componente/Delete/' + row.comp_Id + '"><i class="mdi mdi-delete-empty"></i></a>';
                            }
                            return botones;
                        }
                    }
...
function redireccionar(params) {
    ...
    window.location = '/Componente/Delete';
}