                ...
                columnDefs: [
...

                    {
                        ...
                        render: function (data, type, row) {
                            ...
                            if (type == "display") {
                                botones += '<a class="btn btn-secondary btn-sm" href="/Role/EditarRol/' + row.rol_Id + '"><i class="mdi mdi-square-edit-outline"></i></a> | ';
                                botones += '<button class="btn btn-danger btn-sm" onclick="EliminarRol(' + row.rol_Id + ')"><i class="mdi mdi-delete-empty"></i></button>';
                            }
                            return botones;
                        }
                    }
...
function redireccionar() {
    window.location = '/Role/AgregarRol';
}