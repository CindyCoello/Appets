    ...
    if (muni_Codigo == "") {
        ...
        $.ajax({
            ...
            switch (result) {
                ...
                case "Ingresado":
                case 0:
                    AppetsConfig.alert("success", 'Registro ingresado correctamente');
                ...
                case "Modificado":
                case 1:
                    AppetsConfig.alert("success", 'Registro actualizado correctamente');
                ...
                case "Eliminado":
                case 2:
                    AppetsConfig.alert("success", 'Registro eliminado correctamente');
