appConfig.FichaAdopcion = (function () {
    var obj = {};
            ...
            var table = $('#datatable').DataTable({
                buttons: [
                    ...
                    },
                    {
                        ...
                        attr: {
                            title: "Añadir nueva ficha adopción",
                            id: "add-btn"
                        }
                    }
                ],
                ...
                columnDefs: [
                    ...
                    
                    {
                        ...
                        render: function (data, type, row) {
                            botones = "";
                            if (type == "display") {
                                botones += '<button class="btn btn-secondary btn-sm edit-btn ladda-button" data-style="zoom-in" data-id="' + row.ficha_Id + '"><span class"ladda-label"><i class="mdi mdi-square-edit-outline"></i></span></button> | ';
                                botones += '<button title="Eliminar" class="btn btn-outline-danger btn-sm" onclick="Modal(' + row.ficha_Id + ')"><i class="mdi mdi-delete-forever"></i></button>';
