appConfig.Procedencia = (function () {
    var obj = {};
            ...
            var table = $('#datatable').DataTable({
                buttons: [
                    ...
                    },
                    {
                        ...
                        attr: {
                            title: "Añadir nueva procedencia",
                            id: "add-btn"
                        }
                    }
                ],
                ...
                columnDefs: [
                    ...
                    },
                    {
                        ...
                        render: function (data, type, row) {
                            botones = "";
                            if (type == "display") {
                                botones += '<button class="btn btn-secondary btn-sm edit-btn ladda-button" data-style="zoom-in" data-id="' + row.proc_Id + '"><span class"ladda-label"><i class="mdi mdi-square-edit-outline"></i></span></button> | ';
